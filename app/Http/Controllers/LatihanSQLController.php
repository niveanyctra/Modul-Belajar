...
class LatihanSQLController extends Controller
{
    public function cekSQLBasic(Request $request){
        ...
        return view('latihan.sql.hasil.hasil-basic',compact('cek1','cek2','cek3','cek4','cek5','cek6','cek7','cek8','cek9','cek10',
    ...
    public function cekSQLMenengah(Request $request){
        ...
        $jawab9 = $request->jawaban9;
        $jawab10 = $request->jawaban10;
        return view('latihan.sql.hasil.hasil-menengah',compact('cek1','cek2','cek3','cek4','cek5','cek6','cek7','cek8','cek9','cek10',
        'jawab1','jawab2','jawab3','jawab4','jawab5','jawab6','jawab7','jawab8','jawab9','jawab10'));
    }
    public function cekSQLLanjutan(Request $request){
        ...
        $jawab9 = $request->jawaban9;
        $jawab10 = $request->jawaban10;
        return view('latihan.sql.hasil.hasil-lanjutan',compact('cek1','cek2','cek3','cek4','cek5','cek6','cek7','cek8','cek9','cek10',
        'jawab1','jawab2','jawab3','jawab4','jawab5','jawab6','jawab7','jawab8','jawab9','jawab10'));
    }
}
