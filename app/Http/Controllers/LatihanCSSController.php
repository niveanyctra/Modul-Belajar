...
class LatihanCSSController extends Controller
{
    public function cekCSSBasic(Request $request){
        ...
        return view('latihan.css.hasil.hasil-basic',compact('cek1','cek2','cek3','cek4','cek5','cek6','cek7','cek8','cek9','cek10',
    ...
    public function cekCSSMenengah(Request $request){
        ...
        $jawab9 = $request->jawaban9;
        $jawab10 = $request->jawaban10;
        return view('latihan.css.hasil.hasil-menengah',compact('cek1','cek2','cek3','cek4','cek5','cek6','cek7','cek8','cek9','cek10',
        'jawab1','jawab2','jawab3','jawab4','jawab5','jawab6','jawab7','jawab8','jawab9','jawab10'));
    }
    public function cekCSSLanjutan(Request $request){
        ...
        $jawab9 = $request->jawaban9;
        $jawab10 = $request->jawaban10;
        return view('latihan.css.hasil.hasil-lanjutan',compact('cek1','cek2','cek3','cek4','cek5','cek6','cek7','cek8','cek9','cek10',
        'jawab1','jawab2','jawab3','jawab4','jawab5','jawab6','jawab7','jawab8','jawab9','jawab10'));
    }
}
