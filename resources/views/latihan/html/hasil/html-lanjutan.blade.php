...
<section class="main">
    <div>
        ...
        <form action="{{route('cekBasic')}}" method="post">
            ...
            @endif>
                <pre>
                    &lt;p align="<input disabled type="text" value="{{$jawab1}}" name="jawaban1" id="inputan">"&gt;Text&lt;p&gt;
                </pre>
                {{$cek1}}
            </div>
            ...
            @endif>
                <pre>
                    &lt;p align="<input disabled type="text" value="{{$jawab2}}" name="jawaban2" id="inputan">"&gt;Text&lt;p&gt;
                </pre>
                {{$cek2}}
            </div>
            ...
            @endif>
                <pre>
                    &lt;img <input disabled type="text" value="{{$jawab3}}" name="jawaban3" id="inputan">="image.jpg"&gt;
                </pre>
                {{$cek3}}
            </div>
            ...
            @endif>
                <pre>
                    &lt;img src="image.jpg" <input disabled type="text" value="{{$jawab4}}" name="jawaban4" id="inputan">="100"&gt;
                </pre>
                {{$cek4}}
            </div>
            ...
            @endif>
                <pre>
                    &lt;img src="image.jpg" <input disabled type="text" value="{{$jawab5}}" name="jawaban5" id="inputan">="100"&gt;
                </pre>
                {{$cek5}}
            </div>
            ...
            @endif>
                <pre>
                    &lt;p style="<input disabled type="text" value="{{$jawab6}}" name="jawaban6" id="inputan">:red;"&gt;Text&lt;p&gt;
                </pre>
                {{$cek6}}
            </div>
            ...
            @endif>
                <pre>
                    &lt;p style="font-size:<input disabled type="text" value="{{$jawab7}}" name="jawaban7" id="inputan">;"&gt;Text&lt;p&gt;
                </pre>
                {{$cek7}}
            </div>
            ...
            @endif>
                <pre>
                    &lt;a <input disabled type="text" value="{{$jawab8}}" name="jawaban8" id="inputan">="smkn1cirebon.go.id"&gt;Text&lt;a&gt;
                </pre>
                {{$cek8}}
            </div>
            ...
            @endif>
                <pre>
                    &lt;<input disabled type="text" value="{{$jawab9}}" name="jawaban9" id="inputan">&gt;Text&lt;/<input disabled type="text" value="{{$jawab9}}" name="jawaban9" id="inputan">&gt;
                </pre>
                {{$cek9}}
            </div>
            ...
            @endif>
                <pre>
                    &lt;p style="color:<input disabled type="text" value="{{$jawab10}}" name="jawaban10" id="inputan">:"&gt;Text&lt;p&gt;
                </pre>
                {{$cek10}}
            </div>
