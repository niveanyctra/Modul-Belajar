...
<div class="container-fluid px-5 py-4">
    ...
    <h1 class="fw-bolder display-5">Kelas CSS</h1>
        ...
        <div class="main-kelas">
            <div class="d-flex justify-content-center flex-wrap img-mentor">
                ...
                <div class="card m-3 {{ $data->level }}" style="width: 18rem;">
                    <a href="{{ url('/kelas-mentor/css/'.$data->slug)}}">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><a href="{{ url('/kelas-mentor/css/'.$data->slug)}}">{{$data->title}}</a></h5>
