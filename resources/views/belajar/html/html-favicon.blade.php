...
<aside class="sidebar">
    <nav class="nav-side">
        <h3 class="sidebar-header">HTML Tutorial</h3>
            ...
            <a href="{{url('/belajar/html/favicon')}}" class="active">HTML Favicon</a>
            ...
            <a href="{{url('/belajar/html/id')}}">HTML Id</a>
...
<section class="main">
    <h1>HTML Favicon</h1>
    <a href="{{ url('/belajar/html/image') }}" class="btn btn-success">Sebelumnya</a>
    <a href="{{ url('/belajar/html/page-title') }}" class="btn btn-success">Selanjutnya</a>
</section>
@endsection
