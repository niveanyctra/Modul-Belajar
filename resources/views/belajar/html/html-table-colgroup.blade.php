...
<aside class="sidebar">
    <nav class="nav-side">
        ...
        <h3 class="sidebar-header">HTML Table</h3>
            ...
            <a href="{{url('/belajar/html/table-colgroup')}}" class="active">Table Colgroup</a>
...
<section class="main">
    <h1>HTML Table Colgroup</h1>
    <a href="{{ url('/belajar/html/table-styling') }}" class="btn btn-success">Sebelumnya</a>
