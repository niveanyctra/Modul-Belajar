...
<aside class="sidebar">
    <nav class="nav-side">
        <h3 class="sidebar-header">HTML Tutorial</h3>
            ...
            <a href="{{url('/belajar/html/comment')}}" class="active">HTML Komentar</a>
...
<section class="main">
    <h1>HTML Komentar</h1>
    <a href="{{ url('/belajar/html/quotation') }}" class="btn btn-success">Sebelumnya</a>
    <a href="{{ url('/belajar/html/color') }}" class="btn btn-success">Selanjutnya</a>
</section>
@endsection
