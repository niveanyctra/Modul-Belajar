...
<section class="main">
    ...
    <p>Kamu bisa membuat border di dalam stylesheet dengan property <span class="bg-body secondary text-danger">border</span> pada elemen <span class="bg-body secondary text-danger">&lt;table&gt;</span>,<span class="bg-body secondary text-danger">&lt;th&gt;</span>,<span class="bg-body secondary text-danger">&lt;td&gt;</span>:</p>
    ...
    <br>
    <p>Kamu juga bisa mengganti warna background sel dan juga menggunakan <span class="bg-body secondary text-danger">border-collapse</span> untuk menghindari double border seperti contoh diatas</p>
  ...
  background-color: #96D4D4;<br>
    ...
    <br>
    <p>Kamu juga dapat membuat sudutnya menjadi membulat menggunakan <span class="bg-body secondary text-danger">border-radius</span></p>
