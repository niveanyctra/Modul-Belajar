...
<section class="main">
    ...
    <p>Kita bisa mengatur warna background pada CSS menggunakan properti <mark>background-color</mark> yang akan menghasilkan elemen seperti berikut :</p>
    ...
    <p>Kita juga bisa mengatur warna text dengan property <mark>color</mark> sehingga dapat menghasilkan text sebagai berikut :</p>
    ...
    <p>Selain warna text dan backgroun, kita juga bisa mengatur warna background dengan properti <mark>border-color</mark> yang akan menghasilkan elemen seperti berikut :</p>
